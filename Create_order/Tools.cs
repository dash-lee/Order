...
namespace Create_order
{
    ...
    internal static class Tools
    {
        ...
        public static void Write(string filePath, List<string>? header, List<List<string>> data)
        {
            ...
            if (filePath == desktopPath + @"\config_all\Talka-Ios-Test\b_v3_pay_list.xlsx")
            {
                ModuleSupport.Body_PayList = data;
            }
            else if (filePath == desktopPath + @"\config_all\Talka-Ios-Test\b_v3_channel_price.xlsx")
            {
        ...
        public static List<int> ModifyColumns(string path)
        {
            ...
            if (path == desktopPath + @"\config_all\Talka-Ios-Test\b_v3_pay_type.xlsx")
            {
                return ModuleSupport.modifyFormat["b_v3_pay_type.xlsx"];
            }
            else if (path == desktopPath + @"\config_all\Talka-Ios-Test\b_v3_pay_list.xlsx")
            {
                return ModuleSupport.modifyFormat["b_v3_pay_list.xlsx"];
            }
            else if (path == desktopPath + @"\config_all\Talka-Ios-Test\b_v3_pay_channel.xlsx")
            {
                return ModuleSupport.modifyFormat["b_v3_pay_channel.xlsx"];
            }
            else if (path == desktopPath + @"\config_all\Talka-Ios-Test\b_v3_recharge_promotions.xlsx")
            {
                return ModuleSupport.modifyFormat["b_v3_recharge_promotions.xlsx"];
            }
            else if (path == desktopPath + @"\config_all\Talka-Ios-Test\b_v3_channel_price.xlsx")
            {
                return ModuleSupport.modifyFormat["b_v3_channel_price.xlsx"];
            }
            else if (path == desktopPath + @"\config_all\Talka-Ios-Test\b_v3_channel_price_modify.xlsx")
            {
                return ModuleSupport.modifyFormat["b_v3_channel_price_modify.xlsx"];
            }
            else if(path == desktopPath + @"\config_all\Talka-Ios-Test\tmp.xlsx")
            {
